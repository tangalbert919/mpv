...
const struct m_sub_options macos_conf = {
    .opts = (const struct m_option[]) {
        ...
        {"macos-output-csp", OPT_CHOICE(macos_output_csp,
             ...
             {"itur_2020_srgbgamma", MAC_CSP_ITUR_2020_SRGBGAMMA},
             {"itur_2100_hlg", MAC_CSP_ITUR_2100_HLG},
             {"itur_2100_pq", MAC_CSP_ITUR_2100_PQ},
             {"itur_709_hlg", MAC_CSP_ITUR_709_HLG},
             {"itur_709_pq", MAC_CSP_ITUR_709_PQ},
             {"linear_display_p3", MAC_CSP_LINEAR_DISPLAY_P3},
             {"linear_itur_2020", MAC_CSP_LINEAR_ITUR_2020})},
